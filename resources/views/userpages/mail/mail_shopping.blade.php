								...
								<tr>
									<td align="left" valign="middle" style="width:500px;height:60px">
										<a href="#" style="border:0" target="_blank" width="130" height="35" style="display:block;border:0px">
											<img src="https://drive.google.com/file/d/1G6LOrsXWL1QmfvDBjonXWuweyoTdvzlX/view?usp=sharing" height="100" width="115" style="display:block;border:0px;float: left;"> <b style="float: left;line-height: 100px;color: red;font-size: 20px;">Inspire Store</b>
										</a>
									</td>
							...
							<tbody>
								...
								<tr>
									<td align="left" valign="middle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 20px 10px;line-height:17px">
										Chào 
										@if(is_numeric($orders->order_customer_id))
										{{ $orders->User->name }}
										@else
										{{ $orders->Customer->customer_name }}
										@endif
										,
										<br> Cám ơn bạn đã mua sắm tại Inspire Store
										<br>
							...
							<tbody>
								<tr>
									<td colspan="2" align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#666666;padding:10px 10px 20px 15px;line-height:17px"> 
										...
										<a href="#" style="color:#ed2324;font-weight:bold;text-decoration:none" target="_blank">{{ $orders->order_id }}
										</a>
										<span style="font-size:12px">({{ $orders->created_at }})</span>
									</td>
								</tr>
								...
								<tr>
									<td align="left" valign="top" style="width:120px;padding-left:15px">
										<a href="#_" style="border:0"> 
											<img src="/adminpages/images/{{$o['order_detail_image']}}" height="120" width="120" style="display:block;border:0px"> 
										</a>
									</td>
										...
										<table style="width:100%" cellpadding="0" cellspacing="0" border="0">
											<tbody>
												...
												<tr>
													...
													<td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-bottom:5px">:</td>
													<td align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-left:10px;padding-bottom:5px">
														{{number_format($o['order_detail_product_price']).' '.'VNĐ'}}
													</td>
												</tr>
								...
								<tr>
									<td colspan="2" align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#666666;padding:10px 10px 20px 15px;line-height:17px"> 
										<b>Giảm giá</b> 
										<span style="font-size:12px">({{ number_format($orders->order_coupon_sale).' '.'VNĐ' }})</span>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#666666;padding:10px 10px 20px 15px;line-height:17px"> 
										<b>Tổng tiền</b> 
										<span style="font-size:12px">({{ number_format($orders->order_total_price).' '.'VNĐ' }})</span>
									</td>
								</tr>
								<tr>
									<td colspan="2" align="center" valign="top" style="padding-top:20px;padding-bottom:20px;border-bottom:1px solid #ebebeb">
										<a href="/home" style="border:0px" target="_blank"> 
