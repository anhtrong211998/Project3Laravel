              ...
              <div role="main" id="content">
                <article class="blog_entry clearfix" id="post-29">
                  ...
                  <div class="entry-content">
                    <div class="featured-thumb"><a href="#"><img alt="blog-img4" src="/userpages/images/blog-img4.jpg"></a></div>
                    <div class="entry-content">
                ...
                <div class="comment-content wow">
                  <div class="comments-wrapper">
                    ...
                    <ul class="commentlist">
                      ...
                      <li class="comment">
                        <div class="comment-wrapper" id="post-29">
                          <div class="comment-author vcard"><p class="gravatar"><a href="#"><img width="60" height="60" alt="avatar" src="/userpages/images/avatar60x60.jpg"></a></p> <span class="author">Lisa White</span> </div>
                          <!--comment-author vcard-->
                          <div class="comment-meta">
